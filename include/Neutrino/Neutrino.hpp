...
private:
    ...
    void drawStyledTextLine(Display* d, Drawable drawable, GC gc, const Neu_Theme& theme, const std::string& text, int x, int textY, int maxWidth, bool rich);
